...
public class Checkerboard extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflaterView = inflater.inflate(R.layout.fragment_checkerboard, container, false);
        grid = (GridView) inflaterView.findViewById(R.id.gridView);
    ...
    private void newGrid(int cols){
        grid.setNumColumns(cols);

        grid.setAdapter(new GridViewAdapter(this.getActivity(),cols));
    }
